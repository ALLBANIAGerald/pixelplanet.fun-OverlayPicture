...
function OverlayImageEditRow() {
    const [name, setName] = createSignal('test1');
    return (
        <div class="tw-flex">
            ...
            <input
                ...
                value={name()}
            />
            <div class="todo-canvas-select"></div>
            <div class="todo-coordinates"></div>
            <div class="todo-delete"></div>
            <div class="todo-edit"></div>
            <div class="todo-save"></div>
        </div>
    );
}
